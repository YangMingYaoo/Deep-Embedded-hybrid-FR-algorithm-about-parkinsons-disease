function [ LSVTProposed_H_experiment1_RF ] =  LSVTProposed_H_experiment1_RF()
...
%        Trainingdata=cell(iter,1); % For saving the training data from each iteration to calculate the corresponding Alpha
       ...
       for z = 1:iter
           ...
           [fea,U,model,indx,misX,misY] = LSVTProposed_adbstLDPP_H_RF(trainX1,trainY1,validX,validY,type_num);
           Us{z}=U;
...
%    CM1(2,2) = CM(1,1);
   ...
   tr2=[tr2;ACC_svml_tt];   
   LSVTProposed_H_experiment1_RF.ACC = ACC;   
   LSVTProposed_H_experiment1_RF.ACCi = ACCi; 
   LSVTProposed_H_experiment1_RF.F1_score_Final = F1_score_Final; 
   LSVTProposed_H_experiment1_RF.F1_scorei = F1_scorei; 
   LSVTProposed_H_experiment1_RF.G_mean = G_mean; 
   LSVTProposed_H_experiment1_RF.G_meani = G_meani; 
   LSVTProposed_H_experiment1_RF.Pre = Pre;
   LSVTProposed_H_experiment1_RF.Prei = Prei; 
   LSVTProposed_H_experiment1_RF.Rec = Rec; 
   LSVTProposed_H_experiment1_RF.Reci = Reci; 
   LSVTProposed_H_experiment1_RF.Spe = Spe; 
   LSVTProposed_H_experiment1_RF.Spei = Spei;
