...
%        Trainingdata=cell(iter,1); % For saving the training data from each iteration to calculate the corresponding Alpha
       ...
       for z = 1:iter
           ...
           [fea,U,model,indx,misX,misY] = ProposedHit_adbstLDPP(trainX1,trainY1,validX,validY,type_num);
           Us{z}=U;
...
function [f,U1,mode2,indx,missed_samples,missed_labels] = ProposedHit_adbstLDPP(trainx,trainy,validx,validy,type_num)
