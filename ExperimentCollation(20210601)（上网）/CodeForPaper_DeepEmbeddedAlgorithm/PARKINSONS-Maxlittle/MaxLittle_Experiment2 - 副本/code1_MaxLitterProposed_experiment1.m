...
iter = 10
for C = 1:iter
    [MaxLittlerProposed_experiment1_s2] = MaxLitterProposed_experiment1_svm21()
    final_eval{C} =  MaxLittlerProposed_experiment1_s2;
end
...
function [ MaxLitterProposed_experiment1_svm2 ] = MaxLitterProposed_experiment1_svm21()
...
scores = [];
ensemble = [];
MaxLitterProposed_experiment1_svm2 = [];
...
%        Trainingdata=cell(iter,1); % For saving the training data from each iteration to calculate the corresponding Alpha
       ...
       for z = 1:iter
           ...
           [fea,U,model,indx,misX,misY] = MaxLitterProposed_adbstLDPP_svm2(trainX1,trainY1,validX,validY,valid_data,type_num);
           Us{z}=U;
...
%    TNR = TN / (FN + TN)
   ...
   tr2=[tr2;ACC_svml_tt];   
   MaxLitterProposed_experiment1_svm2.ACC = ACC;   
   MaxLitterProposed_experiment1_svm2.ACCi = ACCi; 
   MaxLitterProposed_experiment1_svm2.Pre = Pre;
   MaxLitterProposed_experiment1_svm2.Prei = Prei
   MaxLitterProposed_experiment1_svm2.Rec = Rec; 
   MaxLitterProposed_experiment1_svm2.Reci = Reci; 
   MaxLitterProposed_experiment1_svm2.Spe = Spe; 
   MaxLitterProposed_experiment1_svm2.Spei = Spei;
   MaxLitterProposed_experiment1_svm2.G_mean = G_mean; 
   MaxLitterProposed_experiment1_svm2.G_meani = G_meani; 
   MaxLitterProposed_experiment1_svm2.F1_scorei = F1_scorei; 
   MaxLitterProposed_experiment1_svm2.F1_score= F1_score; 
   MaxLitterProposed_experiment1_svm2.FinalAcci = Final_Accuracy_with_Adaboosti
   MaxLitterProposed_experiment1_svm2.Final_Acc = Final_Acc;
end
toc
end
...
function [f,U1,mode2,indx,missed_samples,missed_labels]= MaxLitterProposed_adbstLDPP_svm2(trainx,trainy,validx,validy,valid_data,type_num)
