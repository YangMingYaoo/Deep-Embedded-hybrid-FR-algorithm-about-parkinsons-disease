function [ LSVTProposed_H_experiment1_svm0 ] =  LSVTProposed_H_experiment1_svm()
...
scores = [];
ensemble = [];
LSVTProposed_H_experiment1_svm0 = [];
...
%        Trainingdata=cell(iter,1); % For saving the training data from each iteration to calculate the corresponding Alpha
       ...
       for z = 1:3
           ...
           [fea,U,model,indx,misX,misY] = LSVTProposed_adbstLDPP_H_svm0(trainX1,trainY1,validX,validY,type_num);
           Us{z}=U;
...
%    CM1(2,2) = CM(1,1);
   ...
   tr2=[tr2;ACC_svml_tt];   
   LSVTProposed_H_experiment1_svm0.ACC = ACC;   
   LSVTProposed_H_experiment1_svm0.ACCi = ACCi; 
   LSVTProposed_H_experiment1_svm0.F1_score_Final = F1_score_Final; 
   LSVTProposed_H_experiment1_svm0.F1_scorei = F1_scorei; 
   LSVTProposed_H_experiment1_svm0.G_mean = G_mean; 
   LSVTProposed_H_experiment1_svm0.G_meani = G_meani; 
   LSVTProposed_H_experiment1_svm0.Pre = Pre;
   LSVTProposed_H_experiment1_svm0.Prei = Prei; 
   LSVTProposed_H_experiment1_svm0.Rec = Rec; 
   LSVTProposed_H_experiment1_svm0.Reci = Reci; 
   LSVTProposed_H_experiment1_svm0.Spe = Spe; 
   LSVTProposed_H_experiment1_svm0.Spei = Spei;
