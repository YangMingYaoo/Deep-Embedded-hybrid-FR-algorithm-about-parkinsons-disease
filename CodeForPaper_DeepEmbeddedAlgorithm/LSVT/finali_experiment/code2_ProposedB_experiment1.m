...
iter = 10
for C = 1:iter
    [LSVTProposed_experiment1_s2] = LSVT_Proposed_experiment1_svm21()
    final_eval{C} = LSVTProposed_experiment1_s2;
end
...
function [ LSVT_Proposed_experiment1_svm2 ] =  LSVT_Proposed_experiment1_svm21()
...
%#  建立混淆矩阵
   ...
   LSVT_Proposed_experiment1_svm2.F1_score= F1_score; 
