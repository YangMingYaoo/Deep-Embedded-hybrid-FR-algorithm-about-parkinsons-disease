function [ LSVTProposed_experiment1_svm0 ] =  LSVTProposed_experiment1_svm0()
...
%        Trainingdata=cell(iter,1); % For saving the training data from each iteration to calculate the corresponding Alpha
       ...
       for z = 1:iter
           ...
           [fea,U,model,indx,misX,misY] = LSVTProposed_adbstLDPP_svm0(trainX1,trainY1,validX,validY,type_num);
           Us{z}=U;
...
%    CM1(2,2) = CM(1,1);
   ...
   tr2=[tr2;ACC_svml_tt];   
   LSVTProposed_experiment1_svm0.ACC = ACC;   
   LSVTProposed_experiment1_svm0.ACCi = ACCi; 
   LSVTProposed_experiment1_svm0.Pre = Pre;
   LSVTProposed_experiment1_svm0.Prei = Prei; 
   LSVTProposed_experiment1_svm0.Rec = Rec; 
   LSVTProposed_experiment1_svm0.Reci = Reci; 
   LSVTProposed_experiment1_svm0.Spe = Spe; 
   LSVTProposed_experiment1_svm0.Spei = Spei;
    LSVTProposed_experiment1_svm0.G_mean = G_mean; 
   LSVTProposed_experiment1_svm0.G_meani = G_meani; 
   LSVTProposed_experiment1_svm0.F1_score_Final = F1_score_Final; 
   LSVTProposed_experiment1_svm0.F1_scorei = F1_scorei; 
