function [LSVTLDPP_H_Relief_Bagging_Result] = LSVTLDPP_H_Relief_Bagging_Result()
...
scores = [];
ensemble = [];
LSVTLDPP_H_Relief_Bagging_Result = [];
 FinalAcc=[];
 ensemble=[];
for s = 1:3
...
for z = 1 : 3
    a = []
    [fea,U,mode2,indx,misX,misY] =  LSVT_LDPPHRelief_Bagging_adbstLDPP(trainX1,trainY1,validX,validY,type_num)
    Us{z}=U;
    feature{z,1}=fea;
    Medels{z,1} = mode2;
...
m_w = size(weight,1); 
 for q = 1:m_w
   ...
   LSVTLDPP_H_Relief_Bagging_Result.ACC_final_mean = ACC_final_mean;
   LSVTLDPP_H_Relief_Bagging_Result.ACC = ACC;   
   LSVTLDPP_H_Relief_Bagging_Result.ACCi = ACCi; 
   LSVTLDPP_H_Relief_Bagging_Result.F1_score_Final = F1_score_Final; 
   LSVTLDPP_H_Relief_Bagging_Result.F1_scorei = F1_scorei; 
   LSVTLDPP_H_Relief_Bagging_Result.G_mean = G_mean; 
   LSVTLDPP_H_Relief_Bagging_Result.G_meani = G_meani; 
   LSVTLDPP_H_Relief_Bagging_Result.Pre = Pre;
   LSVTLDPP_H_Relief_Bagging_Result.Prei = Prei; 
   LSVTLDPP_H_Relief_Bagging_Result.Rec = Rec; 
   LSVTLDPP_H_Relief_Bagging_Result.Reci = Reci; 
   LSVTLDPP_H_Relief_Bagging_Result.Spe = Spe; 
   LSVTLDPP_H_Relief_Bagging_Result.Spei = Spei; 
