...
iter = 1
for C = 1:iter
    [MaxLittlerProposed_experiment1] = MaxLitterProposed_experiment1_svm21()
    final_eval{C} =  MaxLittlerProposed_experiment1;
end
...
function [ MaxLitterProposed_experiment1_svm0 ] = MaxLitterProposed_experiment1_svm21()
...
scores = [];
ensemble = [];
MaxLitterProposed_experiment1_svm0 = [];
...
%    TNR = TN / (FN + TN)
   ...
   tr2=[tr2;ACC_svml_tt];   
   MaxLitterProposed_experiment1_svm0.ACC = ACC;   
   MaxLitterProposed_experiment1_svm0.ACCi = ACCi; 
   MaxLitterProposed_experiment1_svm0.Pre = Pre;
   MaxLitterProposed_experiment1_svm0.Prei = Prei
   MaxLitterProposed_experiment1_svm0.Rec = Rec; 
   MaxLitterProposed_experiment1_svm0.Reci = Reci; 
   MaxLitterProposed_experiment1_svm0.Spe = Spe; 
   MaxLitterProposed_experiment1_svm0.Spei = Spei;
   MaxLitterProposed_experiment1_svm0.G_mean = G_mean; 
   MaxLitterProposed_experiment1_svm0.G_meani = G_meani; 
   MaxLitterProposed_experiment1_svm0.F1_scorei = F1_scorei; 
   MaxLitterProposed_experiment1_svm0.F1_score= F1_score; 
   MaxLitterProposed_experiment1_svm0.FinalAcci = Final_Accuracy_with_Adaboosti
   MaxLitterProposed_experiment1_svm0.Final_Acc = Final_Acc;
end
toc
end
