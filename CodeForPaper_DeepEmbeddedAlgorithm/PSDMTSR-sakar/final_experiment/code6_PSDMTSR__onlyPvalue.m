...
iter = 2
for C = 1:iter
    [Pvalue_Result] = P_value()
    final_eval{C} = Pvalue_Result;
end
...
function [onlyPvalue_Result] = P_value()
        % 记住RF时不返回AUC
...
%    Final_Evaluation_index = [ACC Pre Rec Spe G_mean  F1_score_Final  AUC_final ] 
   ...
   onlyPvalue_Result.ACC_final_mean = ACC_final_mean;
   onlyPvalue_Result.ACC = ACC;   
   onlyPvalue_Result.ACCi = ACCi; 
   onlyPvalue_Result.Pre = Pre;
   onlyPvalue_Result.Prei = Prei;
   onlyPvalue_Result.Rec = Rec; 
   onlyPvalue_Result.Reci = Reci; 
   onlyPvalue_Result.Spe = Spe; 
   onlyPvalue_Result.Spei = Spei;
   onlyPvalue_Result.G_mean = G_mean; 
   onlyPvalue_Result.G_meani = G_meani; 
   onlyPvalue_Result.F1_score = F1_score; 
   onlyPvalue_Result.F1_scorei = F1_scorei; 
   onlyPvalue_Result.svml3 = svml3; 
end