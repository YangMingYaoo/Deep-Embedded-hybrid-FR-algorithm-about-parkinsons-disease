...
% ldpp_Ht
function [LDPP_H_relief_Result] = LDPPRelief()
       % 记住RF时不返回AUC
...
%    Final_Evaluation_index = [ACC Pre Rec Spe G_mean  F1_score_Final  AUC_final ] 
   ...
   LDPP_H_relief_Result.ACC_final_mean = ACC_final_mean;
   LDPP_H_relief_Result.testACC = svml2 ;
   LDPP_H_relief_Result.ACC = ACC;   
   LDPP_H_relief_Result.ACCi = ACCi; 
   LDPP_H_relief_Result.Pre = Pre;
   LDPP_H_relief_Result.Prei = Prei;
   LDPP_H_relief_Result.Rec = Rec; 
   LDPP_H_relief_Result.Reci = Reci; 
   LDPP_H_relief_Result.Spe = Spe; 
   LDPP_H_relief_Result.Spei = Spei;
   LDPP_H_relief_Result.G_mean = G_mean; 
   LDPP_H_relief_Result.G_meani = G_meani; 
   LDPP_H_relief_Result.F1_score = F1_score; 
   LDPP_H_relief_Result.F1_scorei = F1_scorei; 
   LDPP_H_relief_Result.svml3 = svml3; 
end