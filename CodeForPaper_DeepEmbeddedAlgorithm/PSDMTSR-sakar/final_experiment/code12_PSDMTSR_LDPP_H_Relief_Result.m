...
iter = 10
for C = 1:iter
    [MaxLittlerProposed_H_experiment1_s2] = MaxLitterLDPPH_ReliefResult()
    final_eval{C} = MaxLittlerProposed_H_experiment1_s2;
end
mean_final_eval.ACC = (final_eval{1}.ACC + final_eval{2}.ACC + final_eval{3}.ACC)/iter
mean_final_eval.ACCi = (final_eval{1}.ACCi + final_eval{2}.ACCi + final_eval{3}.ACCi)/iter
mean_final_eval.Pre = (final_eval{1}.Pre + final_eval{2}.Pre + final_eval{3}.Pre)/iter
mean_final_eval.Prei = (final_eval{1}.Prei + final_eval{2}.Prei + final_eval{3}.Prei)/iter
mean_final_eval.Rec = (final_eval{1}.Rec + final_eval{2}.Rec+ final_eval{3}.Rec)/iter
mean_final_eval.Reci = (final_eval{1}.Reci + final_eval{2}.Reci+ final_eval{3}.Reci)/iter
mean_final_eval.TNR = (final_eval{1}.TNR + final_eval{2}.TNR + final_eval{3}.TNR)/iter
mean_final_eval.TNRi = (final_eval{1}.TNRi + final_eval{2}.TNRi + final_eval{3}.TNRi)/iter
mean_final_eval.Spe = (final_eval{1}.Spe + final_eval{2}.Spe + final_eval{3}.Spe)/iter
mean_final_eval.Spei = (final_eval{1}.Spei + final_eval{2}.Spei + final_eval{3}.Spei)/iter
mean_final_eval.G_mean = (final_eval{1}.G_mean + final_eval{2}.G_mean + final_eval{3}.G_mean)/iter
mean_final_eval.G_meani = (final_eval{1}.G_meani + final_eval{2}.G_meani + final_eval{3}.G_meani)/iter
mean_final_eval.F1_score = (final_eval{1}.F1_score_Final + final_eval{2}.F1_score_Final + final_eval{3}.F1_score_Final)/iter
mean_final_eval.F1_scorei = (final_eval{1}.F1_scorei + final_eval{2}.F1_scorei + final_eval{3}.F1_scorei)/iter
toc
...
function [MaxLitterLDPPH_Relief_Result] = MaxLitterLDPPH_ReliefResult()
...
m_w = size(weight,1); 
 for q = 1:m_w
   ...
   MaxLitterLDPPH_Relief_Result.ACC = ACC;   
   MaxLitterLDPPH_Relief_Result.ACCi = ACCi; 
   MaxLitterLDPPH_Relief_Result.Pre = Pre;
   MaxLitterLDPPH_Relief_Result.Prei = Prei
   MaxLitterLDPPH_Relief_Result.Rec = Rec; 
   MaxLitterLDPPH_Relief_Result.Reci = Reci; 
   MaxLitterLDPPH_Relief_Result.TNR = TNR;
   MaxLitterLDPPH_Relief_Result.TNRi = TNRi
   MaxLitterLDPPH_Relief_Result.Spe = Spe; 
   MaxLitterLDPPH_Relief_Result.Spei = Spei;
   MaxLitterLDPPH_Relief_Result.G_mean = G_mean; 
   MaxLitterLDPPH_Relief_Result.G_meani = G_meani; 
   MaxLitterLDPPH_Relief_Result.F1_score_Final = F1_score_Final; 
   MaxLitterLDPPH_Relief_Result.F1_scorei = F1_scorei;
