...
iter = 10
for C = 1:iter
    [MaxLittlerProposed_H_experiment1_s2] = lda()
...
%    Final_Evaluation_index = [ACC Pre Rec Spe G_mean  F1_score  ] 
   ...
   lda_Result.ACC_final_mean = ACC_final_mean;
   lda_Result.ACC = ACC;   
   lda_Result.ACCi = ACCi; 
   lda_Result.Pre = Pre;
   lda_Result.Prei = Prei;
   lda_Result.Rec = Rec; 
   lda_Result.Reci = Reci; 
   lda_Result.Spe = Spe; 
   lda_Result.Spei = Spei;
   lda_Result.G_mean = G_mean; 
   lda_Result.G_meani = G_meani; 
   lda_Result.F1_score = F1_score; 
   lda_Result.F1_scorei = F1_scorei; 
   lda_Result.svml3 = svml3
%    lda_Resul.FinalAcci = Final_Accuracy_with_Adaboosti
%    lda_Resul.Final_Acc = Final_Acc;
; 
end
