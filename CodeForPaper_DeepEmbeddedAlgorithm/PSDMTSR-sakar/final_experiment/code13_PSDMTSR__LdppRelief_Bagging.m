...
iter = 1
for C = 1:iter
    [MaxLittlerProposed_H_experiment1_s2] = LdppRelief_Bagging()
...
function [LdppRelief_Bagging_Result] = LdppRelief_Bagging()
    ...
    for z = 1 : iter
        a = []
        [fea,U,mode2,indx,misX,misY] = adbstLDPP(trainX1,trainY1,validX,validY,valid_data,type_num)
        Us{z}=U;
        feature{z,1}=fea;
        Medels{z,1} = mode2;
...
%%%%%%%%%%%%%%%%%%%%%%  //没有参数t//%%%%%%%%%%%%%%%%%%%%%%%%
%   如果是LDPPH,且没有t参数调用这个
% LDPPH_not_Relief_Bagging_adbstLDPP
