% function [f,U1,mode2,indx,missed_samples,missed_labels] = LSVTProposed_adbstLDPP_H_svm2(trainx,trainy,validx,validy,type_num)
% 
% kk=5;
% mukgamma=[];
% mean_svml8_max=0;
...
t_accuracy(it) = max(max( Accuracy));
end
