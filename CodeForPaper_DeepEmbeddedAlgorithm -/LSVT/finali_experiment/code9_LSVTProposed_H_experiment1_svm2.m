function [ sakarProposed_H_experiment1_svm2 ] =  LSVTProposed_H_experiment1_svm2()
...
scores = [];
ensemble = [];
sakarProposed_H_experiment1_svm2 = [];
...
%        Trainingdata=cell(iter,1); % For saving the training data from each iteration to calculate the corresponding Alpha
       ...
       for z = 1:3
           ...
           [fea,U,model,indx,misX,misY] = LSVTProposed_adbstLDPP_H_svm2(trainX1,trainY1,validX,validY,type_num);
           Us{z}=U;
...
%            [svm_pred1,votes] = classRF_predict(test1,mod1)
      ...
      %% Prediction  预测精度计算
       ...
       Result = sign(Final_predict);   % 这里是sign 符号函数，证明用的还是AdaBoost算法的最终融合。
...
%    CM1(2,2) = CM(1,1);
   ...
   tr2=[tr2;ACC_svml_tt];   
   sakarProposed_H_experiment1_svm2.ACC = ACC;   
   sakarProposed_H_experiment1_svm2.ACCi = ACCi; 
   sakarProposed_H_experiment1_svm2.F1_score_Final = F1_score_Final; 
   sakarProposed_H_experiment1_svm2.F1_scorei = F1_scorei; 
   sakarProposed_H_experiment1_svm2.G_mean = G_mean; 
   sakarProposed_H_experiment1_svm2.G_meani = G_meani; 
   sakarProposed_H_experiment1_svm2.Pre = Pre;
   sakarProposed_H_experiment1_svm2.Prei = Prei; 
   sakarProposed_H_experiment1_svm2.Rec = Rec; 
   sakarProposed_H_experiment1_svm2.Reci = Reci; 
   sakarProposed_H_experiment1_svm2.Spe = Spe; 
   sakarProposed_H_experiment1_svm2.Spei = Spei;
