function [LSVTLDPP_H_Relief_Adaboost_Result] = LSVTLDPP_H_Relief_Adaboost_Result()
...
scores = [];
ensemble = [];
LSVTLDPP_H_Relief_Adaboost_Result = [];
 FinalAcc=[];
 ensemble=[];
for s = 1:3
...
trainY1 = trainY;
    ...
    a = []
    for z = 1:1
    [fea,U,mode2] = LSVT_LDPPHRelief_Adaboost_adbstLDPP(trainX1,trainY1,validX,validY,type_num)
    Us{z}=U;
    feature{z,1}=fea;
    Medels{z,1} = mode2;
...
m_w = size(weight,1); 
 for q = 1:m_w
   ...
   LSVTLDPP_H_Relief_Adaboost_Result.ACC_final_mean = ACC_final_mean;
   LSVTLDPP_H_Relief_Adaboost_Result.ACC = ACC;   
   LSVTLDPP_H_Relief_Adaboost_Result.ACCi = ACCi; 
   LSVTLDPP_H_Relief_Adaboost_Result.F1_score_Final = F1_score_Final; 
   LSVTLDPP_H_Relief_Adaboost_Result.F1_scorei = F1_scorei; 
   LSVTLDPP_H_Relief_Adaboost_Result.G_mean = G_mean; 
   LSVTLDPP_H_Relief_Adaboost_Result.G_meani = G_meani; 
   LSVTLDPP_H_Relief_Adaboost_Result.Pre = Pre;
   LSVTLDPP_H_Relief_Adaboost_Result.Prei = Prei; 
   LSVTLDPP_H_Relief_Adaboost_Result.Rec = Rec; 
   LSVTLDPP_H_Relief_Adaboost_Result.Reci = Reci; 
   LSVTLDPP_H_Relief_Adaboost_Result.Spe = Spe; 
   LSVTLDPP_H_Relief_Adaboost_Result.Spei = Spei; 
