...
function [ Proposed_H_Result ] = Proposed__experiment()
clc;
clear all;
close all;
warning('off');
...
scores = [];
ensemble = [];
self_KG_Proposed_H_experiment1_svm0 = [];
...
%         P = ensemble(:,1) * w1(1,1)+ ensemble(:,2) * w1(1,2) + ensemble(:,3) * w1(1,3);
   ...
   tr2=[tr2;ACC_svml_tt];   
   self_KG_Proposed_H_experiment1_svm0.ACC = ACC;   
   self_KG_Proposed_H_experiment1_svm0.ACCi = ACCi;
   self_KG_Proposed_H_experiment1_svm0.Pre = Pre;
   self_KG_Proposed_H_experiment1_svm0.Prei = Prei; 
   self_KG_Proposed_H_experiment1_svm0.Rec = Rec; 
   self_KG_Proposed_H_experiment1_svm0.Reci = Reci;
   self_KG_Proposed_H_experiment1_svm0.Spe = Spe; 
   self_KG_Proposed_H_experiment1_svm0.Spei = Spei;
   self_KG_Proposed_H_experiment1_svm0.G_mean = G_mean; 
   self_KG_Proposed_H_experiment1_svm0.G_meani = G_meani; 
   self_KG_Proposed_H_experiment1_svm0.F1_score = F1_score; 
   self_KG_Proposed_H_experiment1_svm0.F1_scorei = F1_scorei;
